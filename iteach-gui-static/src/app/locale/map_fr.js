var map_fr = {
    ...
    'dialog.select.invert': "Inverser la sélection",
    'dialog.select.all': "Tout sélectionner",
    'dialog.select.none': "Tout désélectionner",
    'logout': "Se déconnecter",
    // Home page
    'home.back': "Fermer",
    'version.help': "Lien vers les pages iTeach",
    // Error page
    'error': "Erreur",
    ...
    'school.hourlyRate.none.short': "n/a",
    ...
    'admin.setup.password': "Mot de passe",
    ...
    'invoice.status.CREATED': "Demandée",
    'invoice.status.GENERATING': "En cours",
    'invoice.status.READY': "Prêt",
    'invoice.status.ERROR': "Erreur",
    'invoice.status.CREATED.long': "La génération de la facture a été demandée.",
    'invoice.status.GENERATING.long': "La facture est en train d'être générée.",
    'invoice.status.READY.long': "La facture a été générée et est disponible pour téléchargement.",
    'invoice.status.ERROR.long': "La facture n'a pas pu être générée.",
