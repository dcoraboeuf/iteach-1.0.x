...
public interface SQL {
    ...
    String INVOICE_CREATE = "INSERT INTO (TEACHER, STATUS, SCHOOL, YEAR, MONTH, GENERATION, INVOICENB, DOWNLOADED, DOCUMENTTYPE) " +
    ...
    String INVOICE_BY_ID = "SELECT ID, SCHOOL, YEAR, MONTH, GENERATION, INVOICENB, DOCUMENTTYPE FROM INVOICE WHERE TEACHER = :teacher AND ID = :invoiceId";
}
