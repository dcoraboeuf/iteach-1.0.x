...
public interface SQL {
    ...
    String ACCOUNT_PROFILE_COMPANY_LOGO = "SELECT COMPANYLOGO_TYPE, COMPANYLOGO_CONTENT FROM ACCOUNT WHERE ID = :id";
    ...
    String STUDENT_BY_CONTRACT = "SELECT * FROM STUDENT WHERE TEACHERID = :teacherId AND CONTRACTID = :contractId ORDER BY NAME ASC";
    ...
    String CONTRACT_BY_SCHOOL = "SELECT * FROM CONTRACT WHERE TEACHERID = :teacherId AND SCHOOLID = :schoolId ORDER BY NAME ASC";
    String CONTRACT_CREATE = "INSERT INTO CONTRACT(TEACHERID, SCHOOLID, NAME, HOURLYRATE, VATRATE) VALUES (:teacherId, :schoolId, :name, :hourlyRate, :vatRate)";
    String CONTRACT_BY_ID = "SELECT * FROM CONTRACT WHERE TEACHERID = :teacherId AND ID = :id";
    String CONTRACT_DELETE = "DELETE FROM CONTRACT WHERE TEACHERID = :teacherId AND ID = :id";
    String CONTRACT_UPDATE = "UPDATE CONTRACT SET NAME = :name, HOURLYRATE = :hourlyRate, VATRATE = :vatRate WHERE TEACHERID = :teacherId AND ID = :id";
    String CONTRACT_RESET_STUDENTS = "UPDATE STUDENT SET CONTRACTID = NULL WHERE TEACHERID = :teacherId AND CONTRACTID = :id";
}
