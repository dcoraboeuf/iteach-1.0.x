...
public interface SQL {
    ...
    String ACCOUNT_PASSWORD_CHECK = "SELECT ID FROM ACCOUNT WHERE MODE = 'PASSWORD' AND IDENTIFIER = :username AND PASSWORD = :encodedPassword AND VERIFIED IS TRUE AND DISABLED IS FALSE";
